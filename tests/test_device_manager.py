...
class TestDeviceDetector:
    ...
    @patch('device_manager.DeviceDetector._check_torch_availability')
    ...
    @patch('device_manager.psutil.cpu_count')
    @patch('device_manager.psutil.virtual_memory')
    ...
    @patch('device_manager.DeviceDetector._check_torch_availability')
    @patch('device_manager.DeviceDetector._detect_cpu_capabilities')
...
class TestMemoryManager:
    ...
    def test_get_memory_info_cpu(self):
        ...
        with patch('device_manager.psutil.virtual_memory') as mock_memory:
            mock_memory.return_value = MagicMock(
...
class TestPerformanceMonitor:
    ...
    @patch('device_manager.psutil.cpu_percent')
    @patch('device_manager.psutil.virtual_memory')
...
class TestDeviceManager:
    ...
    def test_initialization_success(self):
        ...
        with patch('device_manager.DeviceDetector.detect_devices') as mock_detect:
