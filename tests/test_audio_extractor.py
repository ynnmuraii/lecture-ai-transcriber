...
from src.models import AudioMetadata, AudioExtractionResult, AudioExtractionError
...
class TestAudioExtractor:
    ...
    @patch('src.audio_extractor.ffmpeg.probe')
    @patch('src.audio_extractor.ffmpeg.run')
    @patch('src.audio_extractor.ffmpeg.output')
    @patch('src.audio_extractor.ffmpeg.input')
