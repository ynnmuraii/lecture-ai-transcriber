...
from models import (
    Configuration, ConfigurationError, ModelLoadingError,
    WhisperModelSize, LLMProvider, GPUStatus, EnvironmentStatus
)
...
def load_config(config_path: str = "config/config.yaml") -> Configuration:
    """
