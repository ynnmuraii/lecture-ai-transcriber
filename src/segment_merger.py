...
from src.models import (
    TranscriptionSegment, ProcessedText, FlaggedContent,
    TranscriptionError, ModelLoadingError, LLMProvider
)
...
class SegmentMerger:
    ...
    WORD_FRAGMENT_PATTERNS = [
        ...
        (r'\b(пре|при|про|под|над|раз|рас|без|бес|вы|вз|воз|вос|из|ис|низ|нис|об|от|пере|по|с|со|у)\s*$', 
         r'^\s*(\w+)', 'prefix'),
